...
export const tutorialSteps = [
    ...
    { title: 'Select a source corner', target: '[aria-label="Card controls mini map"] svg', text: 'Use the four corner nodes in the mini map to choose a SOURCE corner. In the SOURCE panel, this mini map controls corners only. Adjust inner guides in WARP.' },
    { title: 'Choose a step size', target: '[data-tour="step-size"]', text: 'Choose how far each nudge moves the selected corner. On mobile, Step Size sits below each panel\'s controls. Start larger, then reduce it for precision. Both selectors stay in sync.' },
    ...
    { title: 'Review the inner borders', target: '[data-tour="warp"]', text: 'Check the estimated inner guides against the printed border. Drag a guide, or select a mini-map side and nudge it. These guides determine the centering ratios.' },
