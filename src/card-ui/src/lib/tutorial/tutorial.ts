...
export const tutorialSteps = [
    ...
    { title: 'Nudge an inner guide', target: '[data-guide-arrows]', text: 'Select a side in the Adjustments mini map, then use the arrows. Notice how the selected inner guide moves in the WARP panel. Align it with the printed border; reduce Step Size for finer moves.', mobileText: 'Select a line in the WARP mini map, then use its arrows. Notice how the selected inner guide moves in the WARP panel. Align it with the printed border; use Step Size below the controls for finer moves.' },
