						...
						<div class="flex w-full items-center justify-start xl:justify-center">
							...
							>
								<line
									...
									stroke={isMapGuideActive('top') ? '#f87171' : '#22d3ee'}
									...
									stroke={isMapGuideActive('bottom') ? '#f87171' : '#22d3ee'}
									...
									stroke={isMapGuideActive('left') ? '#f87171' : '#22d3ee'}
									...
									stroke={isMapGuideActive('right') ? '#f87171' : '#22d3ee'}
